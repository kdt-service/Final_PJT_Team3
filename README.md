...
- 채널 분석 (최근 업로드한 5개 영상)
    ...
    - 각 영상별 댓글 분석
        ...
        - 긍정/부정 (감성분석)
        - 날짜 감성 변화
<img width="1440" alt="개인채널" src="https://github.com/kdt-service/Final_PJT_Team3/assets/123911402/be3129d8-e373-409d-a486-e413e939e6d9">
...
<img width="1440" alt="채널비교분석" src="https://github.com/kdt-service/Final_PJT_Team3/assets/123911402/b88a7604-0888-47f4-810c-6cd7fb324699">

- 채널별 부정어 사전 구축 및 차단
    - 부정어 사전에 등록할 단어 목록 제공
    - 부정어 등록 및 삭제
    - 부정어 등록시 해당 단어가 포함된 댓글 차단
<img width="1440" alt="부정어 블락처리" src="https://github.com/kdt-service/Final_PJT_Team3/assets/123911402/d84c9bd7-559d-4901-adfa-a24b5dc911ef">
